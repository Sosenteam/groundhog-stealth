...
func enter(previous_state_path: String, data := {}) -> void:
	...
	indicate_tween.tween_property(phil.indicator_arrow,"position",phil.direction*50,1).set_trans(Tween.TRANS_EXPO)
	...
	view_length_tween.tween_property(phil,"view_length",500,3).set_trans(Tween.TRANS_EXPO)
